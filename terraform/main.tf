module "service" {
  source = "/home/nelcandido/Arquitetura_Containers_AWS/aca-curso-containers-ecs-service-modulo"
  ...
  service_listener            = data.aws_ssm_parameter.ssm_listener.value
  ...
  private_subnets = [
    data.aws_ssm_parameter.ssm_private_subnet_1.value,
    data.aws_ssm_parameter.ssm_private_subnet_2.value,
    data.aws_ssm_parameter.ssm_private_subnet_3.value,
  ]
